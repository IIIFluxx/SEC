 ...
 */
//NOTE: Class for generating UI/GUI related code // unedited from Workshop materials
    ...
    private void buildInterface()
    {
        ...
        searchButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                // finder.search(); ----- Search method from this class isn't used anymore.
            }
        });


        // Rest of the code is GUI-related - not necessary to edit.
