...
public class AddUI
{
    ...
    public AddUI(ObservableList<TimetableEntry> entries, Locale locale, ResourceBundle bundle)
    {
    ...
    public void addEntry()
    {
        if(dialog == null)
        {
            ...
            dialog = new Dialog<>();
            dialog.setTitle(bundle.getString("addentry_txt"));
            dialog.getDialogPane().setContent(content);
            dialog.getDialogPane().getButtonTypes().addAll(ButtonType.OK, ButtonType.CANCEL);
            dialog.setResultConverter(this::buildEntry);
            content.setHgap(SPACING);
            content.setVgap(SPACING);
            content.add(new Label(bundle.getString("routeid_txt")),           0, 0);
            content.add(new Label(bundle.getString("from_txt")),               0, 1);
            content.add(new Label(bundle.getString("destination_txt")),        0, 2);
            content.add(new Label(bundle.getString("departure_txt")),     0, 3);
            content.add(new Label(bundle.getString("duration_txt")), 0, 4);
